...
app.post("/api/mail", (req, res) => {
  ...
  const barang-yang-dipesan = req.body.barang-yang-dipesan;
                                ...
                                <tr>
                                    <td class="ms-content-body">
                                        ...
                                        <table role="presentation" class="table" style="width: 100%; border-top: 1px solid #e2e8f0;">
                                            ...
                                            <tr>
                                                <td id="barang-yang-dipesan">{$description}</td>
...
document.getElementById("barang-yang-dipesan").textContent = barang-yang-dipesan;
